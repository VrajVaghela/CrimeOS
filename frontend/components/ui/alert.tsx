...
const alertVariants = cva(
  "relative w-full rounded-squircle border p-4 [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg~*]:pl-7 transition-colors duration-[var(--motion-fast)]",
  {
    variants: {
      variant: {
        ...
        warning: "border-accent/50 bg-accent/10 text-accent-foreground [&>svg]:text-accent",
