...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-squircle-sm text-sm font-medium transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 select-none",
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          "border border-border bg-card text-foreground hover:bg-white/[0.04] hover:border-border/80 active:bg-white/[0.06]",
        destructive:
