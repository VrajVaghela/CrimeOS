...
const TABS = [
  { key: "overview", label: "Overview", href: "", icon: Shield, color: "text-primary border-primary", group: "Overview" },
  { key: "ingestion", label: "Ingestion", href: "ingestion", icon: Search, color: "text-info border-info", group: "Work" },
  { key: "path", label: "Investigation", href: "path", icon: Crosshair, color: "text-violet border-violet", group: "Work" },
  { key: "requests", label: "Requests", href: "requests", icon: Mail, color: "text-accent border-accent", group: "Work" },
  { key: "responses", label: "Responses", href: "responses", icon: Activity, color: "text-success border-success", group: "Work" },
  { key: "evidence", label: "Evidence", href: "evidence", icon: Camera, color: "text-primary border-primary", group: "Evidence" },
  { key: "timeline", label: "Timeline", href: "timeline", icon: Clock, color: "text-violet border-violet", group: "Record" },
  { key: "summary", label: "Summary", href: "summary", icon: Radar, color: "text-info border-info", group: "Record" },
  { key: "audit", label: "Audit", href: "audit", icon: Network, color: "text-rose border-rose", group: "Record" },
] as const;
        ...
        <div className="mx-auto w-full max-w-7xl px-4 pt-4 pb-0 sm:px-6">
          ...
          <nav className="flex items-center gap-4 overflow-x-auto pb-1.5 scrollbar-none text-xs font-mono select-none" aria-label="Case sections">
            ...
            >
              ...
              {t("nav.overview" as any) || "Overview"}
            </Link>
              ...
              {TABS.filter((t) => t.group === "Work").map((tab) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-xs font-medium">{t(`nav.${tab.key}` as any) || tab.label}</span>
                  </Link>
                );
              })}
            </div>
