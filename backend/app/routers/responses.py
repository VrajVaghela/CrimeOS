...
@router.get("/cases/{case_id}", response_model=list[ProviderResponseOut], summary="Get provider responses for a case")
...
@router.get("/requests/{request_id}", response_model=ProviderResponseOut, summary="Get provider response for a specific request")
