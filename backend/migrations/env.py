...
=============================================
Configures Alembic to use async SQLAlchemy engine from the application's
database connection module. Supports both online and offline migration modes.
"""
...
# Add the parent directory to sys.path so 'database' and 'config' can be imported
...
def get_database_url() -> str:
    """Retrieve the database URL from application config.

    Returns:
        str: The async database URL for PostgreSQL via asyncpg.
    """
...
def run_migrations_online() -> None:
    """Run migrations in 'online' mode, dispatching to async handler."""
